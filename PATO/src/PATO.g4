...
escopoFunc: AQ (declaracao| comandos | condicoes | retorno | atribuicao | relacao)+ FQ #NRegraEscopoDeclaracao;
declaracao: Tipo Var ';' #RegraDeclaracao;
retorno: RTN ( expressao | atribuicao | AP funcao OpArit funcao? FP ) DELIM #RegraRetorno;
funcao: Var AP ( expressao | atribuicao )+ FP #RegraFuncao;
...
comandos: OpArit #RegraComandosOpArit| input #RegraComandosInput| output #RegraComandosOutput;
relacao: OpBool #RegraRelacao;
...
output: QOUT OPOUT expressao DELIM #RegraOutput;
